...
* **📈 Visual Analytics Dashboard**
    Integrated **Chart.js** visualizations provide a breakdown of study time distribution across core CPA subjects, helping to identify and correct imbalances in your study plan.
